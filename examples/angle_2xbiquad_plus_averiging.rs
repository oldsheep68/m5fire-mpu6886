...
//! 
//! ============================================================
//! implements 2x biquad mit einstellbarer frequenz, welche hintereinander
//! durchlaufen werden. zusätzlich kann der eingangswert gemittelt werden.
//! das ganze wird bei tiefen frequenzen recht träge aber kann auch je nach werte auf 
//! ca. 0.05° stabiele Werte erzeugen
...
fn main() -> ! {
    ...
    loop {
        ...
        if count == AVERAGE_NUMBER || initi_done {
                ...
                println!("x_angle: {:.3} {:.3} {:.3} {:.3} xa: {:.5} {:.5} ya: {:.5} {:.5} T: {:.2}", 
                                                            angle360, 
                                                            xy_angle_min, 
                                                            xy_angle_max, 
